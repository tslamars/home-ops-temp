# No longer relevant as I am now using rook-ceph
## Using different bootstrap method that injects op secrets

This is meant to be kept around for historical purposes.
